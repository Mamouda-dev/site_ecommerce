        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable(3)">passwords <i class="fas fa-sort"></i></th>
                    <th onclick="sortTable(4)">user_type <i class="fas fa-sort"></i></th>
                    <th>Statut</th>
                    <th>Actions</th>
                </tr>
            </thead>
            ...
            ?>
                ...
                <tr>
                    ...
                    <a href="suprimer_client.php?id=<?=$v["id"]?>"><button class="action-btn"><i class="fas fa-trash"></i> </button></a>  
